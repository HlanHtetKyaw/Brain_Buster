...
public class Main extends Application {
	...
	void styleElements() {
		...
		root.getChildren().addAll(rainImg,lineRec,brain,centerRec,donutImg,donut0Img,coneImg,squareImg,questionImg,moonImg);
	}
	void letStart() {
	...
	private void AgeAccept(ActionEvent event) {
        ...
        if (selectButtonNode != null) {
            ...
            selectButtonNode.setOnMouseEntered(e -> {
                selectButtonNode.setStyle("-fx-background-color: #20AB2E;"+
                		"-fx-border-radius: 200;" +
                        "-fx-background-radius: 50;"+
                        "-fx-font-size: 19px;"+
                        "-fx-text-fill: WHITE;"+
